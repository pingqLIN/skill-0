...
- [skill-0-dashboard/apps/web/src/api/client.ts](<repo-root>/skill-0-dashboard/apps/web/src/api/client.ts)
- [skill-0-dashboard/apps/web/src/auth/AuthProvider.tsx](<repo-root>/skill-0-dashboard/apps/web/src/auth/AuthProvider.tsx)
- [skill-0-dashboard/apps/web/src/auth/context.ts](<repo-root>/skill-0-dashboard/apps/web/src/auth/context.ts)
- [skill-0-dashboard/apps/web/src/auth/useAuth.ts](<repo-root>/skill-0-dashboard/apps/web/src/auth/useAuth.ts)
- [skill-0-dashboard/apps/web/src/pages/Login.tsx](<repo-root>/skill-0-dashboard/apps/web/src/pages/Login.tsx)
...
- [.nvmrc](<repo-root>/.nvmrc)
- [skill-0-dashboard/apps/web/package.json](<repo-root>/skill-0-dashboard/apps/web/package.json)
...
- [docker-compose.prod.yml](<repo-root>/docker-compose.prod.yml)
- [Dockerfile.api](<repo-root>/Dockerfile.api)
- [Dockerfile.dashboard](<repo-root>/Dockerfile.dashboard)
