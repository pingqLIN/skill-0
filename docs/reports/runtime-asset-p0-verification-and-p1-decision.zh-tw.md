...
| FTS5/hybrid ranking | **NO-GO — representative evidence 未通過固定 gates** | 固定 84-query suite 包含 lexical、semantic 各 42；所有 profiles 未通過 25% storage gate，lexical nDCG gain 只有 0.0347、低於 0.05，最小 profile 另未通過 relative latency；詳見 [`runtime-asset-p1-search-evidence.zh-tw.md`](runtime-asset-p1-search-evidence.zh-tw.md) |
