...
description: Comprehensive guide for working with Power Apps Canvas Apps YAML structure based on Microsoft Power Apps YAML schema v3.0. Covers Power Fx formulas, control structures, data types, and source control best practices. Triggers on: **/*.{yaml,yml,md,pa.yaml}
triggers: "**/*.{yaml,yml,md,pa.yaml}"
globs: "**/*.{yaml,yml,md,pa.yaml}"
---
