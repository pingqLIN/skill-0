...
description: Comprehensive Power BI data modeling best practices based on Microsoft guidance for creating efficient, scalable, and maintainable semantic models using star schema principles. Triggers on: **/*.{pbix,md,json,txt}
triggers: "**/*.{pbix,md,json,txt}"
globs: "**/*.{pbix,md,json,txt}"
---
