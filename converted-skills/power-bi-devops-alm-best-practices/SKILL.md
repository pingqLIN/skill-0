...
description: Comprehensive guide for Power BI DevOps, Application Lifecycle Management (ALM), CI/CD pipelines, deployment automation, and version control best practices. Triggers on: **/*.{yml,yaml,ps1,json,pbix,pbir}
triggers: "**/*.{yml,yaml,ps1,json,pbix,pbir}"
globs: "**/*.{yml,yaml,ps1,json,pbix,pbir}"
---
