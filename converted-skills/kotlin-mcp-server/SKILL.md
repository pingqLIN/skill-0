...
description: Best practices and patterns for building Model Context Protocol (MCP) servers in Kotlin using the official io.modelcontextprotocol:kotlin-sdk library. Triggers on: **/*.kt, **/*.kts, **/build.gradle.kts, **/settings.gradle.kts
triggers: "**/*.kt, **/*.kts, **/build.gradle.kts, **/settings.gradle.kts"
