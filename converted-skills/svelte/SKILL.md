...
name: svelte
description: Svelte 5 and SvelteKit development standards and best practices for component-based user interfaces and full-stack applications Triggers on: **/*.svelte, **/*.ts, **/*.js, **/*.css, **/*.scss, **/*.json
triggers: "**/*.svelte, **/*.ts, **/*.js, **/*.css, **/*.scss, **/*.json"
globs: "**/*.svelte, **/*.ts, **/*.js, **/*.css, **/*.scss, **/*.json"
---
