...
class TestScanAction:
    ...
    def test_scan_source_path_missing(self, client, mock_service):
    ...
    def test_scan_skill_not_found_returns_error_code(self, client, mock_service):
        mock_service.run_scan.return_value = {
            "status": "failed",
            "skill_id": "ghost",
            "processed": 0,
        ...
        resp = client.post("/api/skills/scan?skill_id=ghost")
        assert resp.status_code == 200
        data = resp.json()
        assert data["error_code"] == "PATH_NOT_FOUND"

    def test_scan_empty_target_noop(self, client, mock_service):
    ...
    def test_scan_batch_partial_success(self, client, mock_service):
...
class TestTestAction:
    ...
    def test_test_installed_path_missing(self, client, mock_service):
    ...
    def test_test_empty_target_noop(self, client, mock_service):
    ...
    def test_test_batch_partial_success(self, client, mock_service):
