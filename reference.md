...
- The live schema source of truth is [schema/skill-decomposition.schema.json](/home/miles/dev2/skill-0/schema/skill-decomposition.schema.json), currently `v2.4.0`.
- The active remediation baseline for contract/governance cleanup is [project-improvement-plan-2026-03-27.zh-TW.md](/home/miles/dev2/skill-0/docs/project-improvement-plan-2026-03-27.zh-TW.md).
- Complex-skill schema extension work is being designed in [schema-extension-design-complex-skills-2026-03-24.md](/home/miles/dev2/skill-0/docs/schema-extension-design-complex-skills-2026-03-24.md).
